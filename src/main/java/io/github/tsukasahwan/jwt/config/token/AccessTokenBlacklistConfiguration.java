...
import io.github.tsukasahwan.jwt.config.token.storage.caffeine.CaffeineAccessTokenBlacklistConfig;
import io.github.tsukasahwan.jwt.config.token.storage.redis.RedisAccessTokenBlacklistConfig;
